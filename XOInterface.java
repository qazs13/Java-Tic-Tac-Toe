...
public class XOInterface {
    ...
    private Boolean moveReceived;
     private String nameOfSwitchedPage = null;       
    public XOInterface()
    {
        Players = new Vector<>();
    }
    public XOInterface(String typeOfOperation,String nameOfSwitchedPage)
    {
        this.typeOfOperation = typeOfOperation;
        this.nameOfSwitchedPage=nameOfSwitchedPage;
    }
    ...
    public String getnameOfSwitchedPage()
    {
        return nameOfSwitchedPage;
    }
