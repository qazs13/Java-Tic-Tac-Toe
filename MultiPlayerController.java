...
public class MultiPlayerController implements Initializable {
    ...
    /*public static void main(String[] args){
        Gamelog onlineGameChating = new Gamelog("Mayar", "Aya", "hello aya");
        XOInterface xo = new XOInterface("send", onlineGameChating);
        Gson toServer = new Gson();
        String message = toServer.toJson(xo);
        System.out.println(message);
        MultiPlayerController mi = new MultiPlayerController();
        mi.printMessage(xo);
    }*/
}
